...
function ChatPanel(props){
  ...
  return (<><style>{"@keyframes fabRipple{0%{transform:scale(0.9);opacity:0.6}100%{transform:scale(1.9);opacity:0}}@keyframes fabEntrance{0%{transform:translateY(40px) scale(0.6);opacity:0}60%{transform:translateY(-4px) scale(1.06);opacity:1}100%{transform:translateY(0) scale(1);opacity:1}}@keyframes fabFloat{0%,100%{transform:translateY(0)}50%{transform:translateY(-4px)}}@keyframes fabShimmer{0%{background-position:0% 50%}100%{background-position:200% 50%}}@keyframes fabLabelIn{0%{transform:translateX(12px);opacity:0}100%{transform:translateX(0);opacity:1}}@keyframes sparkleOrbit{0%{transform:rotate(0deg) translateX(34px) rotate(0deg)}100%{transform:rotate(360deg) translateX(34px) rotate(-360deg)}}"}</style>
  {!isOpen&&<div style={{position:"fixed",right:24,bottom:24,zIndex:900,display:"flex",alignItems:"center",gap:10,flexDirection:"row-reverse",pointerEvents:"none",animation:"fabEntrance 0.8s cubic-bezier(0.34,1.56,0.64,1) both"}}>
    {/* FAB wrapper with ripples */}
    <div style={{position:"relative",width:68,height:68,pointerEvents:"auto",animation:"fabFloat 4s ease-in-out infinite"}} onMouseEnter={function(){hover[1](true);}} onMouseLeave={function(){hover[1](false);}}>
      ...
      <div style={{position:"absolute",inset:0,pointerEvents:"none"}}>
        <div style={{position:"absolute",top:"50%",left:"50%",width:6,height:6,marginLeft:-3,marginTop:-3,borderRadius:"50%",background:"#FFAA00",boxShadow:"0 0 10px #FFAA00, 0 0 20px #F96203",animation:"sparkleOrbit 6s linear infinite"}}/>
      </div>
      {/* Actual button */}
      <button onClick={openPanel} aria-label="Chat with GAS Media Expert" style={{position:"relative",width:"100%",height:"100%",borderRadius:"50%",border:"none",cursor:"pointer",background:"linear-gradient(135deg,#FF3D00 0%,#FF6B00 40%,#F96203 70%,#A855F7 130%)",backgroundSize:"200% 200%",animation:"fabShimmer 5s ease-in-out infinite alternate",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:hover[0]?"0 16px 40px rgba(255,61,0,0.55), 0 0 0 2px rgba(255,255,255,0.12) inset, 0 0 60px rgba(168,85,247,0.35)":"0 10px 30px rgba(255,61,0,0.45), 0 0 0 1px rgba(255,255,255,0.08) inset",transform:hover[0]?"scale(1.08)":"scale(1)",transition:"transform 0.25s cubic-bezier(0.34,1.56,0.64,1), box-shadow 0.3s",outline:"none"}}>
        ...
        {/* AI badge */}
        <div style={{position:"absolute",top:-2,right:-2,minWidth:22,height:18,borderRadius:9,background:"#0d0618",border:"1.5px solid #FFAA00",color:"#FFAA00",fontSize:9,fontWeight:900,fontFamily:fm,letterSpacing:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 5px",boxShadow:"0 2px 8px rgba(255,170,0,0.45)"}}>AI</div>
      </button>
    </div>
    {/* Hover label */}
      ...
      <div style={{flex:1,minWidth:0}}>
        ...
        {tab==="overview"&&(<div>
          ...
          <div style={{background:P.glass,borderRadius:18,padding:"6px 24px 24px",marginBottom:28,border:"1px solid "+P.rule}}>
            ...
            {(function(){
              ...
              var objectives=["App Store Clicks","Landing Page Clicks","Followers & Likes","Leads"];
        ...
        {tab==="targeting"&&(<div>
          ...
          {(function(){
            ...
            var objList3=["App Store Clicks","Landing Page Clicks","Followers & Likes","Leads"];
