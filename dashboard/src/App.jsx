...
function ChatPanel(props){
  ...
  {!isOpen&&<div style={{position:"fixed",right:22,bottom:22,zIndex:900,display:"flex",alignItems:"center",gap:10,flexDirection:"row-reverse",pointerEvents:"none",animation:"fabEntrance 0.8s cubic-bezier(0.34,1.56,0.64,1) both"}}>
    {/* AI Expert launcher: 64x64 gradient circle with stacked AI / EXPERT
        text. Every visual style is inline so the button can never lose
        its shape/colour through a CSS-load race or specificity battle.
        CSS class only carries hover state, the breathing-ring pseudo-
        elements on the parent, and the sibling-selector label visibility. */}
    <div className="gas-fab-target">
      <button className="gas-fab-btn" onClick={openPanel} aria-label="Chat with GAS Media Expert" style={{
        ...
        animation:"fabShimmer 5s ease-in-out infinite alternate",
