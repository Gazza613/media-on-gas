...
function ChatPanel(props){
  ...
  {!isOpen&&<div style={{position:"fixed",right:22,bottom:22,zIndex:2147483600,display:"flex",alignItems:"center",gap:10,flexDirection:"row-reverse",pointerEvents:"none",animation:"fabEntrance 0.8s cubic-bezier(0.34,1.56,0.64,1) both"}}>
    ...
    <div className="gas-fab-label" style={{opacity:0,visibility:"hidden",background:"rgba(6,2,14,0.95)",backdropFilter:"blur(10px)",WebkitBackdropFilter:"blur(10px)",border:"1px solid "+P.rule,borderRadius:14,padding:"10px 16px",boxShadow:"0 10px 30px rgba(0,0,0,0.5)",whiteSpace:"nowrap"}}>
