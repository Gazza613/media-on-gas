          ...
          <div style={{fontSize:12,color:P.txt,fontFamily:fm,lineHeight:1.55}}>
            {approvedNow ? "Cleared for launch. Hit Create campaign whenever ready." :
              (approvalState.status === "pending"
                ? "Approval email sent to Gary. The Launch button unlocks the moment he clicks Approve. Polls every 5 seconds."
                : "Daily budgets over R3,000 or lifetime over R20,000 need approval from Gary. Click Request approval below to send the email.")}
          </div>
