  ...
  <tr><td align="center">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background:linear-gradient(170deg,#0F1820 0%,#13202C 100%);border-radius:20px;overflow:hidden;border:1px solid rgba(168,85,247,0.18);">
      ...
      <tr><td style="padding:28px 40px 8px;" align="center">
        <!--[if mso]>
        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${signupUrl}" style="height:50px;v-text-anchor:middle;width:260px;" arcsize="24%" stroke="f" fillcolor="#FF5A1F">
          <w:anchorlock/>
          <center style="color:#ffffff;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;font-weight:900;letter-spacing:3px;text-transform:uppercase;">ACCEPT INVITATION</center>
        </v:roundrect>
        <![endif]-->
        <!--[if !mso]><!-->
        <a href="${signupUrl}" style="background-color:#FF5A1F;background-image:linear-gradient(135deg,#FF3D00,#FF6B00);border-radius:12px;color:#ffffff;display:inline-block;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;font-weight:900;letter-spacing:3px;padding:16px 42px;text-decoration:none;text-transform:uppercase;mso-hide:all;">Accept Invitation</a>
        <!--<![endif]-->
