...
# Remove any remaining negative/cautionary language from insights
# These are all in the overview tab insights

# Awareness - remove any negative frequency language
c = c.replace(
...
# Make the conversion rate insight always positive
c = c.replace(
    'convR+"% conversion rate reflects the current funnel performance for this campaign period."',
    'convR+"% conversion rate demonstrates active lead capture from the campaign\\'s paid traffic."'
)

with open("/workspaces/media-on-gas/dashboard/src/App.jsx", "w") as f:
    f.write(c)
print("Done - all insights client-positive")
