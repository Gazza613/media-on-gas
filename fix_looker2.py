...
# Add Deep Dive tab before optimise tab
c = c.replace(
    'if(!isClient)tabs.push({id:"optimise"',
    'tabs.push({id:"deepdive",label:"Deep Dive",icon:Ic.eye(P.cyan,16)});if(!isClient)tabs.push({id:"optimise"'
)

# Add Deep Dive content before optimise content
c = c.replace(
...
with open("/workspaces/media-on-gas/dashboard/src/App.jsx", "w") as f:
    f.write(c)
print("Done - Deep Dive tab added")
