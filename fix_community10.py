...
# Find and replace the entire community growth section
            ...
            {(function(){
              ...
              sel.forEach(function(camp){
                ...
                if(isFollowLike){
                  ...
                  if(camp.platform==="Instagram"){igSpend+=parseFloat(camp.spend||0);}
                  if(camp.platform==="TikTok"){ttSpend+=parseFloat(camp.spend||0);}
                }
              });
                ...
                <div style={{background:"rgba(0,0,0,0.15)",borderRadius:12,padding:20,marginBottom:20}}>
                  ...
                  <ResponsiveContainer width="100%" height={220}>
                    <BarChart data={[{name:"FB Page Likes",value:fbEarned},{name:"IG Followers",value:igEarned},{name:"TT Follows",value:ttEarned}]} barSize={40}>
                      <CartesianGrid strokeDasharray="3 3" stroke={P.r
cat > /workspaces/media-on-gas/fix_community10.py << 'DONE'
with open("/workspaces/media-on-gas/dashboard/src/App.jsx", "r") as f:
    c = f.read()
...
with open("/workspaces/media-on-gas/dashboard/src/App.jsx", "w") as f:
    f.write(c)
print("Done - community growth redesigned")
